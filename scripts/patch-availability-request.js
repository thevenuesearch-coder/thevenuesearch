...
// Replace the availability check so the contact details are emailed to the Venue Search team.
...
if (!source.includes(oldActions)) throw new Error('Booking action block not found.');
source = source.replace(oldActions, newActions);

fs.writeFileSync(file, source);
console.log('Availability contact and email-request workflow applied.');
